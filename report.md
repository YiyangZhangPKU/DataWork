...
1. 朴素贝叶斯 提供了一个快速、可解释的基线模型。
2. 随机森林 
3. XGBoost 对于样本量较少的数据预测效果不佳，但是对于样本量大的中性情感数据预测效果较好。
4. LSTM 
...
| 姓名   | 学号       | 院系专业  | 分工       |
| ------ | ---------- | --------- | ---------- |
| 卜一凡 | 2200012137 | 生信-大三 | BERT       |
| 韩嘉琪 | 2200012126 | 生信-大三 | XGBoost、报告    |
| 张屹阳 | 2200012170 | 生科-大三 | EDA、报告        |
| 丁健   | 2300016653 | 信管-大二 | 文本向量化、报告草稿 |
| 李思润 | 2300012651  | 地空-大二 | 随机森林   |
| 耿子喻 | 2400013212  | 信科-大一 | LSTM       |
